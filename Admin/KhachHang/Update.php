...
<head>
    ...
    <body >
                ...
                <div class="mainup">
                    ...
                    <table class="tbl" >
                        ...
                        <div class="div--bton">
                            ...
                            <div>
                                <button onclick="return confirm('Bạn có chắc muốn xóa thông tin khách hàng này không ?')" class='btnD' name="btnDelete" type="submit" >
        ...
        <?php
            ...
            function comdele($id){
                echo "<script type='text/javascript'>";
                echo "alert('Bạn sẽ xóa 1 khách hàng khỏi bảng khachhang');";
