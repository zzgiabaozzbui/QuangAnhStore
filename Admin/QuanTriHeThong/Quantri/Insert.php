                    ...
                    <form class="mainf" method="POST" enctype="multipart/form-data">
                        <table class="tbl" >
                            <tr>
                                ...
                                <td>
                                    <select class="inpu" name="quyen" id="quyen" style="width: 150px;background-image: url(https://img.icons8.com/material-rounded/2x/ffffff/conference-background-selected.png); background-position: left;background-size: 25px;">
                                        <option  hidden>Chọn quyền</option>    
                                        <option  value="0">Quản trị</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select  class="inpu" name="tt" id="tt" style="width: 150px;background-image: url(https://img.icons8.com/material-sharp/2x/ffffff/lock.png); background-position: left;background-size: 18px;">
