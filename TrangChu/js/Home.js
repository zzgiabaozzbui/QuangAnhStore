...
var randompPromotion = [
  ...
  {
    items:
      "Giảm 1 triệu khi thanh toán qua ví Moca, thẻ tín dụng ACB, mPos, VIB, BIDV, Shinhan, Standard Charter",
  },
  {
  ...
  {
    items:
      "[HOT] Thu cũ lên đời giá cao - Thủ tục nhanh - Trợ giá lên tới 300.000đ",
  },
  {
...
var danhsachLink = [
  {
    items:
      "https://cellphones.com.vn/sforum/black-friday-diem-mat-loat-deal-dien-thoai-laptop-dong-ho-tai-nghe-phu-kien-giam-gia-cuc-soc-tai-cellphones",
  },
  {
    items:
      "https://cellphones.com.vn/sforum/tong-hop-deal-giam-gia-ngat-ngay-black-friday-ngay-28-11-tai-cellphones",
  },
  {
...
randompPromotion
  ...
  .slice(0, randompPromotion.length);
getDataItemSale();
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        DanhSachSearch.forEach(function (value) {
          ...
          let clitem =
            value.Type == 1
              ? " item-product-dienthoai"
              : " item-product-phukien";
...
$(document).on("click", ".item-product-phukien", function (e) {
  ...
  let url =
    "/../../QuangAnhStore/TrangChu/html/ChucNangTrangChu/ChucNang/infoPhuKien.php";
...
$(document).on("click", ".item-product-dienthoai", function (e) {
  ...
  let url =
    "/../../QuangAnhStore/TrangChu/html/HangDienThoai/ThongTinChiTiet.php";
  let param = new URLSearchParams();
  param.append("MaSP", MaSP);
  url += "?" + param.toString();
  location.href = url;
